...
export default function ManagerDashboardPage() {
  ...
  // Calculate stats
  const todaySales = tenantBills
    .filter(b => b.createdAt.startsWith('2026-07-11') || b.createdAt.startsWith('2026-07-10')) // mock matching
    .reduce((acc, curr) => acc + curr.grandTotal, 0) || 18400;

  const totalExpenses = tenantExpenses.reduce((acc, curr) => acc + curr.cost, 0);

  // Review averages (Food taste, Presentation, Ambiance)
