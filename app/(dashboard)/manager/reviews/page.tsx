...
import { MessageSquare, Star, Reply, Send, Award, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-serif font-bold text-ink uppercase tracking-wider text-ink-soft">Recent Guest Reviews</h3>
        ...
        <div className="space-y-4">
          {tenantReviews.map(review => (
            <Card key={review.id} className="p-5 space-y-4 border-line/60">
              ...
              {/* Owner Response block if already exists */}
