...
import { QrCode, Smartphone, Info, RefreshCw, Sparkles, Volume2 } from 'lucide-react';
...
export default function CustomerScanPage() {
  ...
  const handleSimulateScan = () => {
    ...
    setTimeout(() => {
      ...
      // Simulate sound beep (via visual feedback)
      toast({
        type: 'success',
      ...
      setTimeout(() => {
        ...
        // Redirect to menu page for selected table
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-4 pb-20 space-y-6">
      ...
      <Card className="relative p-0 overflow-hidden bg-stone-900 border border-line/40 h-[420px] flex flex-col justify-between text-white rounded-2xl">
        ...
        {/* Simulator controller bar inside/below viewport */}
