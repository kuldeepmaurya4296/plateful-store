...
import { MapPin, Phone, Mail, MessageSquare, Plus, Check, QrCode, Calendar, Sparkles, Send } from 'lucide-react';

export default function CustomerRestaurantProfilePage() {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-4 pb-20 space-y-6">
      ...
      {/* Action buttons (Follow, Check-in, Book, DM) */}
